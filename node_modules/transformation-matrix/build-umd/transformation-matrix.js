...
function rotate_rotate(angle, cx, cy) {
  var cosAngle = rotate_cos(angle);
  var sinAngle = rotate_sin(angle);
  var rotationMatrix = {
 ...
 * @returns {{a: number, b: number, c: number, e: number, d: number, f: number}} Affine matrix
 */
function rotate_rotateDEG(angle) {
  ...
  return rotate_rotate(angle * rotate_PI / 180, cx, cy);
}
...
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "rotate", function() { return rotate_rotate; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "rotateDEG", function() { return rotate_rotateDEG; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "scale", function() { return scale_scale; });
