...
function convertMatrixDescriptorToMatrix(matrixDescriptor) {
  ...
  switch (type) {
    ...
    case 'translate':
      if (hasParam('ty')) return (0, _translate.translate)(params.tx, params.ty);

      return (0, _translate.translate)(params.tx);

    case 'scale':
      if (hasParam('sy')) return (0, _scale.scale)(params.sx, params.sy);

      return (0, _scale.scale)(params.sx);

    case 'rotate':
      if (hasParam('cx') && hasParam('cy')) return (0, _rotate.rotateDEG)(params.angle, params.cx, params.cy);
