...
var TermExpander = function () {
  ...
  _createClass(TermExpander, [{
    ...
    value: function expandYieldGeneratorExpression(term) {
      var expr = term.expression == null ? null : this.expand(term.expression);
    ...
    value: function expandNewTargetExpression(term) {
      return term;
    }
  }, {
    ...
    key: "expandSuper",
    value: function expandSuper(term) {
      return term;
    }
  }, {
    ...
    value: function expandCompoundAssignmentExpression(term) {
