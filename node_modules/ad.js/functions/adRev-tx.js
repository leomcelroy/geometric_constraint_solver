...
S_tape.prototype.determineFanout = function() { this.fanout += 1 }
S_tape.prototype.initializeSensitivity = function() {
  this.sensitivity = 0;
  this.fanout -= 1;
}
S_tape.prototype.reversePhase = function(sensitivity) {
...
var tape1 = function(e, primal, factor, tape) {
  return new S_tape1(e, primal, factor, tape);
}
var tape2 = function(e, primal, factor1, factor2, tape1, tape2) {
  return new S_tape2(e, primal, factor1, factor2, tape1, tape2);
}

var isTape = function(t) { return t instanceof S_tape; };

var tapify = function(p) {return new S_tape(_e_, p)}
...
var makeTapifier = function() {
  ...
  return (function() {
    var eThis = _e_;
    return function(p) {return new S_tape(eThis, p);};
  }())
}
...
var lift_real_to_real = function(f, df_dx) {
  var fn = function(x1) {
    if (isTape(x1))
      return tape1(x1.epsilon, fn(x1.primal), df_dx(x1.primal), x1);
    else
      return f(x1);
  }
  return fn;
    ...
    if (isTape(x_1)) {
      if (isTape(x_2))
        if (x_1.epsilon < x_2.epsilon)
          return tape1(x_2.epsilon, fn(x_1, x_2.primal), df_dx2(x_1, x_2.primal), x_2)
      else if (x_2.epsilon < x_1.epsilon)
        return tape1(x_1.epsilon, fn(x_1.primal, x_2), df_dx1(x_1.primal, x_2), x_1)
      else
        return tape2(x_1.epsilon,
  ...
  var xSensitivities = _.map(ySensitivities, function(ySensitivity) {
    forEachDependent1(function(yReverse) {
      if (isTape(yReverse) && !lt_e(yReverse.epsilon, thisE)) {
        yReverse.determineFanout();
        yReverse.initializeSensitivity();
      }
    }, yReverse);
    forEachDependent2(function(yReverse, ySensitivity) {
      if (isTape(yReverse) && !lt_e(yReverse.epsilon, thisE)) {
        yReverse.determineFanout();
        yReverse.reversePhase(ySensitivity);
      }
