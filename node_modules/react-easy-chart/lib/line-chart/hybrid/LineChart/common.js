...
function createParser() {
  var pattern = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '%d-%b-%y';
...
function createFormat() {
  var pattern = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '%b %d';

  return TIMEFORMAT[pattern] || (TIMEFORMAT[pattern] = (0, _d.timeFormat)(pattern));
}
...
function createScaleTimeX() {
  ...
  return (0, _d.scaleTime)().domain(domain).range([0, x]);
}
...
function createScaleTimeY() {
  ...
  return (0, _d.scaleTime)().domain(domain).range([y, 0]);
}
